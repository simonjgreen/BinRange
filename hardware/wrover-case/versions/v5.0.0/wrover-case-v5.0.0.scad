// Makerfabs ESP32 UWB DW3000 / WROVER-E enclosure, V5. All units mm.
...
// V4 pins and PCB pressure springs physically passed; V5 closure needs a print test.
...
assert(clip_engagement >= 0.5 && clip_engagement <= 0.8);
...
echo(str("V5 internal-lip body: ",outer_l," x ",outer_w," x ",total_h," mm"));
echo(str("Four PCB springs: free preload ",board_preload,
         "; nominal preload at latch stop ",board_preload-clip_lift_clearance," mm"));
echo("Both parts are in print orientation; use matching V5 base and lid.");
