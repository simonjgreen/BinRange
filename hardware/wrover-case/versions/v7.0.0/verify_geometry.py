...
expected={'closed':False,'rigid_insertion':False,'components':False,'catch_left':True,'catch_right':True,'release':False,'release_board':False,'allowed_play':False,'locating_x':True,'locating_y':True}
