// Makerfabs ESP32 UWB DW3000 / WROVER-E case v7.1.0, millimetres.
...
// v7.1: cone roots match the nominal PCB holes at the seating plane; vents centred.
// Closure and PCB leaf geometry retained from physically successful v7.0.0.
...
echo(str("v7.1.0 matched pair: ",outer_l," x ",outer_w," x ",total_h," mm"));
